<template>
  <main class="container page-section creation-page">
    <div class="heading">
      ...
      <RouterLink class="button button-primary" to="/write">写文章</RouterLink>
    </div>
