...
.study-zone-container { min-height: 0; min-width: 0; max-width: 100%; padding: 0; background: transparent; color: var(--text); }
.study-layout { max-width: none; min-width: 0; gap: var(--space-4); margin: 0; }
.study-page-header { display: flex; align-items: flex-start; justify-content: space-between; gap: var(--space-4); min-width: 0; }.study-page-header > div { min-width: 0; }.study-page-header h2 { margin: var(--space-1) 0; font-size: 1.6rem; letter-spacing: -.025em; }.study-page-header > div > p:last-child { margin: 0; color: var(--muted); }
.study-header-bar { align-items: center; gap: var(--space-3); min-width: 0; padding: var(--space-3) 0; border-color: var(--border); }.category-tabs-wrapper { gap: var(--space-2); min-width: 0; }.study-category-btn { min-height: 34px; padding: 0 var(--space-3); border-color: var(--border); border-radius: var(--radius-sm); background: var(--surface-raised); color: var(--muted); transition: border-color .15s ease, background .15s ease, color .15s ease; }.study-category-btn:hover { transform: none; border-color: var(--accent); background: var(--accent-soft); color: var(--accent); }.study-category-btn.active { border-color: var(--accent); background: var(--accent-soft); box-shadow: none; color: var(--accent); }
...
.study-toolbar { justify-content: space-between; min-width: 0; padding: var(--space-3); border-color: var(--border); border-radius: var(--radius); background: var(--surface); }.toolbar-left-group, .toolbar-right-group { align-items: center; flex-wrap: wrap; gap: var(--space-2); min-width: 0; }.study-tool-btn { display: inline-flex; align-items: center; gap: var(--space-2); min-height: 38px; padding: 0 var(--space-3); border-color: var(--border); border-radius: var(--radius-sm); background: var(--surface-raised); color: var(--text); }.study-tool-btn:hover:not(:disabled) { transform: none; border-color: var(--accent); background: var(--accent-soft); }.study-tool-btn.button-primary { background: var(--accent); border-color: var(--accent); color: #fff; }.study-tool-btn.button-primary:hover:not(:disabled) { background: var(--accent-strong); color: #fff; }.study-tool-btn.button-danger { color: var(--danger); }.view-toggle { display: inline-flex; padding: 2px; border: 1px solid var(--border); border-radius: var(--radius-sm); background: var(--surface-raised); }.view-toggle button { display: grid; width: 30px; height: 30px; place-items: center; padding: 0; border: 0; border-radius: 6px; color: var(--muted); background: transparent; }.view-toggle button.active { color: var(--accent); background: var(--accent-soft); }
.study-files-container { display: grid; gap: var(--space-5); min-width: 0; }.study-category-block { min-width: 0; padding-top: 0; border: 0; }.study-category-heading { display: flex; justify-content: space-between; align-items: baseline; min-width: 0; margin-bottom: var(--space-2); }.study-category-heading h3 { margin: 0; font-size: 1rem; }.study-category-heading span { color: var(--muted); font-size: .8rem; }.study-files-grid { gap: var(--space-2); min-width: 0; grid-template-columns: repeat(auto-fill, minmax(170px, 1fr)); }.study-files-grid.is-list { grid-template-columns: 1fr; }.study-file-card { display: grid; grid-template-columns: auto minmax(0, 1fr); align-items: center; gap: var(--space-2) var(--space-3); min-height: 86px; min-width: 0; padding: var(--space-3); text-align: left; border: 1px solid var(--border); border-radius: var(--radius); background: var(--surface); color: var(--text); box-shadow: none; cursor: pointer; }.study-file-card:hover { transform: none; border-color: var(--accent); box-shadow: var(--shadow); }.study-files-grid.is-list .study-file-card { grid-template-columns: auto minmax(0, 1fr) auto; min-height: 58px; }.study-file-icon { display: grid; width: 38px; height: 38px; place-items: center; border-radius: var(--radius-sm); background: var(--accent-soft); color: var(--accent); font-size: inherit; }.study-file-name { min-width: 0; overflow: hidden; color: var(--text); font-weight: 650; text-overflow: ellipsis; white-space: nowrap; }.study-file-meta { grid-column: 2; min-width: 0; color: var(--muted); font-size: .78rem; }.study-files-grid.is-list .study-file-meta { grid-column: 3; white-space: nowrap; }.selection-indicator { position: absolute; display: grid; width: 20px; height: 20px; place-items: center; border: 1px solid var(--accent); border-radius: 50%; background: var(--accent); color: #fff; }.study-file-card.selectable { position: relative; }.study-file-card.selected { border-color: var(--accent); background: var(--accent-soft); }.study-empty-block { display: inline-flex; align-items: center; gap: var(--space-2); padding: var(--space-4); border: 1px dashed var(--border); border-radius: var(--radius); background: transparent; color: var(--muted); }.main-empty { width: 100%; justify-content: center; min-height: 180px; }
@media (max-width: 760px) { .study-page-header { align-items: stretch; flex-direction: column; }.study-email-btns { width: 100%; max-width: 100%; }.study-header-bar { align-items: stretch; flex-direction: column; }.study-search-box { width: 100%; max-width: none; }.study-toolbar { align-items: stretch; flex-direction: column; }.toolbar-left-group, .toolbar-right-group { justify-content: flex-start; max-width: 100%; }.study-tool-btn { flex: 1 1 auto; justify-content: center; }.study-files-grid { grid-template-columns: 1fr; }.study-files-grid.is-list .study-file-card { grid-template-columns: auto minmax(0, 1fr); }.study-files-grid.is-list .study-file-meta { grid-column: 2; }.category-tabs-wrapper { width: 100%; max-width: 100%; flex-wrap: nowrap; overflow-x: auto; padding-bottom: var(--space-1); } }
