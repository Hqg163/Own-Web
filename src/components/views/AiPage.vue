...
@media (max-width: 760px) { .ai-page__header { align-items: start; flex-direction: column; }.ai-history-toggle { display: inline-flex; }.ai-page__workspace { display: block; }.ai-page__history { display: none; margin-bottom: var(--space-4); padding: var(--space-3); border: 1px solid var(--border); border-radius: var(--radius); background: var(--surface); }.ai-page__history.is-open { display: block; }.ai-page__chat { min-height: calc(100vh - 220px); }.ai-page__chat-head { flex-direction: column; }.ai-page__chat-head label, .ai-page__chat-head select { width: 100%; max-width: none; } }
</style>
